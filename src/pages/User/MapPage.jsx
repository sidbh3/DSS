...
const MapPage = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-100 flex flex-col items-center p-6">
      <header className="w-full flex items-center justify-between p-4 bg-secondary text-white shadow-md">
      ...
      <main className="flex flex-col items-center w-full mt-6 space-y-4">
        <div className="flex items-center w-full max-w-3xl bg-white rounded shadow-md p-2">
          <input
            type="text"
            placeholder="Search"
        ...
        <div className="w-full max-w-4xl mt-4">
          <div className="bg-white rounded shadow-md overflow-hidden">
            <div className="h-96">
              {/* Replace the src with your map component */}
              <iframe
